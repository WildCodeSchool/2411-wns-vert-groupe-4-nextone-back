...
import { checkRoleInHierarchy, checkStrictRole, validateOrThrow, verifyCreatorPermission } from "@/utils/manager";
...
export default {
    ...
    Mutation: {
        ...
        toggleGlobalAccessManager: async (_: any, { id }: MutationToggleGlobalAccessManagerArgs, ctx : MyContext) => {
            ...
            return buildResponse(updatedManager, "Manager is active.", "Manager is not active.")
        }
    },
};
